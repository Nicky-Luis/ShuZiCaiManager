    ...
    private void initRecyclerView() {
        ...
        wholeAdapter = new QuickAdapter<GuessWholeRecord>(getContext(),
            ...
            protected void convert(BaseAdapterHelper helper, final GuessWholeRecord item) {
                ...
                helper.setText(R.id.whole_name, "用户：" + item.getUserId());
                helper.setText(R.id.whole_forecast, "预测值：" + String.valueOf(item.getGuessValue()));
                helper.setText(R.id.whole_money, String.valueOf(item.getGoldValue())+"金币");
            }
        };
    ...
    private void getUserCount(int periodCount) {
        ...
        query.count(GuessForecastRecord.class, new CountListener() {
            ...
            public void done(Integer integer, BmobException e) {
                whole_refresh_widget.setRefreshing(false);
                if (null == integer) {
                    whole_CountTxt.setText("总人数：0");
                } else {
