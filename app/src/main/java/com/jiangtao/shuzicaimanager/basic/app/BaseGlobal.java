...
import com.jiangtao.shuzicaimanager.basic.utils.SdCardUtil;
...
public class BaseGlobal {
     ...
     * 主数据库的名称
     */
    public static final String DATABASE_NAME = APPNAME + ".db";

    /**
     * 文件根目录
     */
    public static final String STORAGEPATH = SdCardUtil.getNormalSDCardPath() + "/" +
            APPNAME + "/";
